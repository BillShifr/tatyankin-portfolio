...
const Layout = () => {
  ...
  return (
    ...
    >
      ...
      <ScrollBlockModal
        title="Снова торопимся сразу проскролить?) Позволь словить твой фокус"
        content={`Привет! 👋\n\nЭто мое портфолио, где собрана информация о моем опыте работы, технологиях и проектах.\n\nЗдесь вы найдете:\n• Детальный опыт работы с реальными проектами\n• Полный стек технологий, с которыми я работаю\n• Принципы и подходы к разработке\n• Контактную информацию\n\nПрокрутите вниз, чтобы узнать больше!`}
      />
    </div>
  )
}
